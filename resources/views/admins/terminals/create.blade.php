        ...
        <div class="col-12 col-md-10 col-lg-8 col-xl-7">
            <div class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-center gap-2 mb-3">
                <div>
                    ...
                    <div class="text-secondary opacity-75">Lege ein neues Terminal an.</div>
                </div>
            ...
            <div class="card border-0 shadow-lg rounded-4 overflow-hidden">
                ...
                <div class="card-body p-4 p-md-5 bg-light">
                    <form method="POST" action="{{ route('terminals.store') }}" class="mb-0">
                        @csrf

                        <div class="mb-4">
                            <label class="form-label fw-semibold text-secondary" for="name">Name</label>
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-start justify-content-between gap-3">
                                        ...
                                        <div class="form-check form-switch m-0">
                                            ...
                                            <input class="form-check-input" type="checkbox" name="enabled" id="enabled" value="1" {{ old('enabled', '1') === '1' ? 'checked' : '' }}>
